...
print(f'Latest trade ID: {most_recent}')

for i in range(13):
    print(f'File {i} should contain ID {i*j_range*request_limit*1000} to ID {((i+1)*j_range*request_limit*1000)-1}')
...
for i in i_list:
    ...
    for j in range(j_range):
        ...
        for k in range(k_range):
            ...
            trades = client.get_historical_trades(symbol='BTCUSDT', limit=1000, fromId=last_old_trade+1, requests_params={'timeout': 60})
